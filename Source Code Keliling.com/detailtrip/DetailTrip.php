    ...
    <div id="body-outer">
        <div id="body-upper">
            ...
            <div id="body-upper-container">
                <img id=jogja src="./image/jogja.jpg" alt="" style="width:100%;">
            ...
            <div class="mid-upper">
                ...
                <div class="mid-content-view">
                    ...
                    <div class= mid-mid>
                        <div class="mid-content">
                            <div class="list">
                            <h3 class= mid>Stasiun Yogyakarta</h3> 
                            </div>
                            <div class="list">  
                            <h3 class= mid>Stasiun Yogyakarta</h3>
                            </div>
        ...
        <div id="body-bottom">
                ...
                <div class="mySlides">
                    ...
                    <img class="img-bottom" src="image/bogor.jpg" style="width:100%;">
                </div>

                <div class="mySlides">
                    <div class="numbertext">2 / 6</div>
                    <img class="img-bottom" src="image/bondowoso.jpg" style="width:100%">
                </div>

                <div class="mySlides">
                    <div class="numbertext">3 / 6</div>
                    <img class="img-bottom"src="image/jogja.jpg" style="width:100%">
                </div>
                    
                <div class="mySlides">
                    <div class="numbertext">4 / 6</div>
                    <img class="img-bottom" src="image/karimun.jpg" style="width:100%">
                </div>

                <div class="mySlides">
                    <div class="numbertext">5 / 6</div>
                    <img class="img-bottom"src="image/lembang.jpg" style="width:100%">
                </div>
                    
                <div class="mySlides">
                    <div class="numbertext">6 / 6</div>
                    <img class="img-bottom"src="image/Malang.jpg" style="width:100%">
                </div>
                ...
                <div class="row">
                    <div class="column">
                    <img class="demo cursor img-bottom" src="image/bogor.jpg" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
                    </div>
                    <div class="column">
                    <img class="demo cursor img-bottom" src="image/bondowoso.jpg" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
                    </div>
                    <div class="column">
                    <img class="demo cursor img-bottom" src="image/jogja.jpg" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
                    </div>
                    <div class="column">
                    <img class="demo cursor img-bottom" src="image/karimun.jpg" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
                    </div>
                    <div class="column">
                    <img class="demo cursor img-bottom" src="image/lembang.jpg" style="width:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
                    </div>    
                    <div class="column">
                    <img class="demo cursor img-bottom" src="image/Malang.jpg"style="width:100%" onclick="currentSlide(6)" alt="Snowy Mountains">
                    </div>
                </div>
            </div>
        </div>
